...
Original file is located at
    https://colab.research.google.com/drive/1OjhX3XGhyQwvVIptYuFejhVt95BtxdEc
"""
...
# En fazla 5 denemede alınan en az değer.
print((100/34796616)*abs(34796616-34701390))#20 (165sn)
print((100/34571080)*abs(34571080-34286329))#15 (85sn)
print((100/30657403)*abs(30657403-30638171))#10 (64sn)
print((100/ 4722044)*abs(4722044 -4713833 ))#5 (4sn)

o=0
region_count=10
for i in range(1,region_count+1):
    for j in range(1,region_count+1):
      if data_d0[j][i]!=0: #Talep olan teslimat noktalarını analizi.
        o+=1